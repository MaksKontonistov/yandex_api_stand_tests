...
def negative_assert_symbol(first_name):
    ...
    # Проверяется, статус в ответе равен 400
...
# Тест 7. Ошибка
# Параметр fisrtName состоит из слов с пробелом
...
# Тест 9. Ошибка
# Параметр fisrtName состоит из чисел
def test_create_user_has_number_in_first_name_get_error_response():
    negative_assert_symbol("123")

# Функция для негативной проверки 2
